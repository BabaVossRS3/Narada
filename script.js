...
const menuMobilePage = document.querySelector('.menu-mobile');

// nav buttons for navigation
const homeBtn = document.querySelector('.home-btn-nav');
const visionBtn = document.querySelector('.our-vision-btn-nav');
const menuBtn = document.querySelector('.menu-btn-nav');
const reservationBtn = document.querySelector('.reservation-btn-nav');
const contactBtn = document.querySelector('.contact-btn-nav');

// mobile menu  buttons for navigation
const mobileHomeBtn = document.querySelector('.mobile-home-btn-nav');
const mobileVisionBtn = document.querySelector('.mobile-our-vision-btn-nav');
const mobileMenuBtn = document.querySelector('.mobile-menu-btn-nav');
const mobileReservationBtn = document.querySelector('.mobile-reservation-btn-nav');
const mobileContactBtn = document.querySelector('.mobile-contact-btn-nav');
...
const barMenuMobileBtn = document.querySelector('.fa-bars');

//toggle mobile menu
barMenuMobileBtn.addEventListener('click', function(){
  menuMobilePage.classList.toggle('visible-mobile-menu');
});
...
let mobilePages = [homePage, ourVisionPage, menuPage, reservationPage, contactPage];
let mobileMenuBtns = [mobileHomeBtn, mobileVisionBtn, mobileMenuBtn, mobileReservationBtn, mobileContactBtn];
let mobileCurrentPage = mobilePages[0];
...
mobileMenuBtns.forEach((button, index) => {
  button.addEventListener('click', function (event) {
    event.preventDefault();
    if (mobileCurrentPage !== mobilePages[index]) {
      buttons.forEach(btn => btn.classList.remove('active-button'));
      button.classList.add('active-button');
      window.scrollTo({ top: 0, behavior: 'smooth' });
      mobileCurrentPage.classList.remove('active');
      mobilePages[index].classList.add('active');
      mobileCurrentPage = mobilePages[index];
      menuMobilePage.classList.remove('visible-mobile-menu');
    }
  });
});
